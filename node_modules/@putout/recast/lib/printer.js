...
var types = (0, tslib_1.__importStar)(require("ast-types"));
var namedTypes = types.namedTypes;
var isString = types.builtInTypes.string;
var isObject = types.builtInTypes.object;
var fast_path_1 = (0, tslib_1.__importDefault)(require("./fast-path"));
...
function genericPrintNoParens(path, options, print) {
    ...
    switch (n.type) {
        ...
        case "Literal":
            return (0, lines_1.fromString)(getPossibleRaw(n) || (typeof n.value === "string"
        ...
        case "TSAsExpression": {
            ...
            parts.push(expression, (0, lines_1.fromString)(" as "), path.call(print, "typeAnnotation"));
            return (0, lines_1.concat)(parts);
        }
