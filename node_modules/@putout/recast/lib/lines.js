...
var source_map_1 = (0, tslib_1.__importDefault)(require("source-map"));
var options_1 = require("./options");
var util_1 = require("./util");
var mapping_1 = (0, tslib_1.__importDefault)(require("./mapping"));
var Lines = /** @class */ (function () {
    ...
    Lines.prototype.stripMargin = function (width, skipFirstLine) {
        ...
        var lines = new Lines(this.infos.map(function (info, i) {
            if (info.line && (i > 0 || !skipFirstLine)) {
                info = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, info), { indent: Math.max(0, info.indent - width) });
            }
            return info;
        }));
    ...
    Lines.prototype.indent = function (by) {
        ...
        var lines = new Lines(this.infos.map(function (info) {
            if (info.line && !info.locked) {
                info = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, info), { indent: info.indent + by });
            }
            return info;
        }));
        if (this.mappings.length > 0) {
    ...
    Lines.prototype.lockIndentTail = function () {
        ...
        return new Lines(this.infos.map(function (info, i) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, info), { locked: i > 0 })); }));
    };
    ...
    Lines.prototype.join = function (elements) {
        ...
        function appendLines(linesOrNull) {
            ...
            linesOrNull.infos.forEach(function (info, i) {
                if (!prevInfo || i > 0) {
                    prevInfo = (0, tslib_1.__assign)({}, info);
                    infos.push(prevInfo);
                }
            });
        }
