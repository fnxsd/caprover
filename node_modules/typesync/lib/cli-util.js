...
exports.parseArguments = exports.spinWhile = exports.error = exports.success = exports.log = void 0;
...
function error(err) {
    ...
    var stack = err instanceof Error ? "\nStack:\n" + err.stack : '';
 ...
 * @param fn
 */
function spinWhile(text, fn) {
    return __awaiter(this, void 0, void 0, function () {
        var spinner;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    spinner = ora(' ' + chalk_1.default.gray(text)).start();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, , 3, 4]);
                    return [4 /*yield*/, fn()];
...
function parseArguments(argv) {
    ...
    for (var _i = 0, argv_1 = argv; _i < argv_1.length; _i++) {
        ...
        if (arg.startsWith('--')) {
            if (arg.includes('=')) {
                var idx = arg.indexOf('=');
                var afterEq = arg.substring(idx + 1);
