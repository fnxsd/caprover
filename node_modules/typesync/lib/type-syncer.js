...
function createTypeSyncer(packageJSONService, typeDefinitionSource, packageSource, configService, globber) {
    var fetchPackageInfo = util_1.memoizeAsync(packageSource.fetch);
    return {
        sync: sync,
    };
    /**
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all(__spreadArrays(util_1.ensureWorkspacesArray(file.packages), util_1.ensureWorkspacesArray(file.workspaces)).map(globber.globPackageFiles))
                                .then(util_1.flatten)
                                .then(util_1.uniq)];
                    case 2:
                        subPackages = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        packageFile = _a;
                        allPackages = util_1.flatten(util_1.filterMap(Object.values(types_1.IDependencySection), function (dep) {
                        ...
                        return [4 /*yield*/, Promise.all(newTypings.map(function (t) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            typePackageInfoPromise = fetchPackageInfo(util_1.typed(t.typingsName));
                                        ...
                                        case 2:
                                            ...
                                            used.push(t);
                                            return [2 /*return*/, (_a = {},
                                                    _a[util_1.typed(t.typingsName)] = semverRangeSpecifier + version,
                                                    _a)];
                                    }
                                });
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, packageJSONService.writePackageFile(filePath, __assign(__assign({}, packageFile), { devDependencies: util_1.orderObject(__assign(__assign({}, devDepsToAdd), removeUnusedTypings(devDeps, unused))) }))];
                    case 4:
                        _b.sent();
                        _b.label = 5;
...
function getUnusedTypings(allPackageNames, devDependencies, allTypings) {
    ...
    var _loop_2 = function (packageName) {
        if (packageName.startsWith('@types/')) {
            var codePackageName_1 = util_1.untyped(packageName);
...
function getClosestMatchingVersion(packageInfo, version) {
    return (packageInfo.versions.find(function (v) { return semver_1.satisfies(v.version, version); }) ||
...
function getPackagesFromSection(section, ignorePackages) {
    return util_1.filterMap(Object.keys(section), function (name) {
