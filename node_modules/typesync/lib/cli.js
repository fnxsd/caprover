            ...
            switch (_a.label) {
                case 0:
                    ...
                    container = awilix_1.createContainer({
                        ...
                        configService: awilix_1.asFunction(config_service_1.createConfigService).singleton(),
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, C.spinWhile("Syncing type definitions in " + chalk_1.default.cyan(filePath) + "...", function () { return syncer.sync(filePath, flags); })];
                case 1:
                    result = _c.sent();
...
function renderSyncedFile(file) {
    ...
    var nl = '\n';
    var combined = __spreadArrays(file.newTypings.map(function (t) { return (__assign(__assign({}, t), { action: 'add' })); }), file.removedTypings.map(function (t) { return (__assign(__assign({}, t), { action: 'remove' })); }));
    var rendered = title +
        nl +
        combined
