...
exports.createPackageSource = void 0;
...
function createPackageSource() {
    ...
    return {
         ...
         */
        fetch: function (name) { return __awaiter(_this, void 0, void 0, function () {
            var data, versions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, npm_client_1.npmClient.getPackageManifest(encodeURIComponent(name))];
                    case 1:
                        data = _a.sent();
                        versions = Object.keys(data.versions).map(function (v) {
                            var item = data.versions[v];
                            return {
                        ...
                        return [2 /*return*/, {
                                ...
                                versions: versions
                                    .sort(function (left, right) { return semver_1.compare(left.version, right.version); })
                                    .reverse(),
                            }];
                }
            });
