...
exports.ensureWorkspacesArray = exports.memoizeAsync = exports.flatten = exports.promisify = exports.orderObject = exports.untyped = exports.typed = exports.mergeObjects = exports.shrinkObject = exports.filterMap = exports.uniq = void 0;
/**
...
function mergeObjects(source) {
    return source.reduce(function (accum, next) { return (__assign(__assign({}, accum), next)); }, {});
}
...
function promisify(fn) {
    return function promisified() {
        ...
        return new Promise(function (resolve, reject) {
            fn.apply(void 0, __spreadArrays(args, [function callback(err, result) {
