...
async function queryVersions(packageMap, options = {}) {
    ...
    async function getPackageVersionProtected(dep) {
        ...
        const cacheKey = (_a = options.cacher) === null || _a === void 0 ? void 0 : _a.key(name, version);
        const cached = (_b = options.cacher) === null || _b === void 0 ? void 0 : _b.get(cacheKey);
        if (cached) {
        ...
        try {
            versionNew = await getPackageVersion(name, version, {
                ...
                retry: (_c = options.retry) !== null && _c !== void 0 ? _c : 2,
            });
        ...
        bar === null || bar === void 0 ? void 0 : bar.tick();
        if (versionNew) {
            (_d = options.cacher) === null || _d === void 0 ? void 0 : _d.set(cacheKey, versionNew);
        }
        return {
            version: versionNew,
        };
